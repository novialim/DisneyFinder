            ...
            function e() {
                function a(a) {
                    ...
                    if ("scroll" === C) {
                        ...
                        r = h.container["scroll" + z],
                        w = r + m(f).position()[z.toLowerCase()] + A) : h.container = null : (r = t.State.scrollAnchor[t.State["scrollProperty" + z]],
                        u = t.State.scrollAnchor[t.State["scrollProperty" + ("Left" === z ? "Top" : "Left")]],
                        w = m(f).offset()[z.toLowerCase()] + A),
                        i = {
                            scroll: {
                                rootPropertyValue: !1,
                                startValue: r,
                        ...
                        for (var G in q) {
                            ...
                            if (g(f).isSVG || "tween" === N || !1 !== v.Names.prefixCheck(N)[1] || v.Normalizations.registered[N] !== d) {
                                ...
                                h._cacheValues && D && D[G] ? (M === d && (M = D[G].endValue + D[G].unitType),
                                O = g(f).rootPropertyValueCache[N]) : v.Hooks.registered[G] ? M === d ? (O = v.getPropertyValue(f, N),
                                ...
                                M = parseFloat(M) || 0,
                                K = parseFloat(K) || 0,
                                "%" === Q && (/^(fontSize|lineHeight)$/.test(G) ? (K /= 100,
                                Q = "em") : /^scale/.test(G) ? (K /= 100,
                                Q = "") : /(Red|Green|Blue)$/i.test(G) && (K = K / 100 * 255,
                                Q = "")),
                                /[\/*]/.test(S))
                                    Q = R;
                                else if (R !== Q && 0 !== M)
                                ...
                                t.debug && console.log("Skipping [" + N + "] due to a lack of browser support.")
                        }
                        i.element = f
                    }
                ...
                !1 === h.queue ? h.delay ? setTimeout(a, h.delay) : a() : m.queue(f, h.queue, function(b, c) {
                    return !0 === c ? (B.promise && B.resolver(o),
...
function(a, b, c, d) {
    ...
    function P(a, b) {
        ...
        return b & (ya | za) && (c = u(c.concat(d), "identifier", !0)),
        [c, d]
    }
    function Q() {
        this.evTarget = Va,
    ...
    function R(a, b) {
        ...
        for (e = 0; e < g.length; )
            ...
            b & (ya | za) && delete d[g[e].identifier],
            e++;
    ...
    j(M, y, {
        handler: function(a) {
            ...
            b & xa && 1 !== a.which && (b = ya),
            this.pressed && this.allow && (b & ya && (this.pressed = !1),
    ...
    a.MSPointerEvent && (Pa = "MSPointerDown",
    Qa = "MSPointerMove MSPointerUp MSPointerCancel"),
    j(N, y, {
        handler: function(a) {
            var b = this.store
              , c = !1
            ...
            e & wa && (0 === a.button || g) ? 0 > h && (b.push(a),
            h = b.length - 1) : e & (ya | za) && (c = !0),
            0 > h || (b[h] = a,
    ...
    j(O, y, {
        handler: function(a) {
            var b = Ra[a.type];
            if (b === wa && (this.started = !0),
            this.started) {
                var c = P.call(this, a, b);
                b & (ya | za) && 0 == c[0].length - c[1].length && (this.started = !1),
                this.callback(this.manager, b, {
                    pointers: c[0],
                    changedPointers: c[1],
                    pointerType: ta,
    ...
    T.prototype = {
        set: function(a) {
            a == Ya && (a = this.compute()),
            Xa && (this.manager.element.style[Wa] = a),
    ...
    V.prototype = {
        ...
        canEmit: function() {
            for (var a = 0; a < this.requireFail.length; ) {
                if (!(this.requireFail[a].state & (32 | cb)))
                    return !1;
                a++
            }
            return !0
        ...
        recognize: function(a) {
            ...
            void (this.state & (db | eb | fb | hb) && this.tryEmit(b))) : (this.reset(),
            void (this.state = 32))
        },
        process: function() {},
    ...
    j($, Z, {
        ...
        directionTest: function(a) {
            ...
            c = f != this.pX,
            d = Math.abs(a.deltaX)) : (e = 0 === g ? Aa : 0 > g ? Da : Ea,
            c = g != this.pY,
            d = Math.abs(a.deltaY))),
            a.direction = e,
    ...
    j(da, V, {
        ...
        emit: function() {
            this.state == gb && (this._input.tapCount = this.count,
            this.manager.emit(this.options.event, this._input))
        }
    }),
    ea.VERSION = "2.0.4",
        ...
        recognize: function(a) {
            ...
            if (!b.stopped) {
                ...
                for (var f = 0; f < d.length; )
                    ...
                    !e && c.state & (db | eb | fb) && (e = b.curRecognizer = c),
                    f++
            }
        },
        get: function(a) {
    ...
    a.fn.dropdown = function(b) {
        ...
        !1) : void this.each(function() {
            ...
            function e(b) {
                ...
                j.addClass("active"),
                g.addClass("active"),
                !0 === h.constrainWidth ? j.css("width", g.outerWidth()) : j.css("white-space", "nowrap");
                ...
                setTimeout(function() {
                    a(document).on("click." + j.attr("id"), function(b) {
                        f(),
                        a(document).off("click." + j.attr("id"))
                    })
                }, 0)
            }
            function f() {
                ...
                var e = a(this)
                  ...
                  , h = function(f) {
                    ...
                    !e.hasClass("open")) {
                        ...
                        e.data("overlay-id", j).css("z-index", 1e3 + 2 * l + 1),
                        e.addClass("open"),
                        a("body").append(k),
    ...
    a.fn.materialbox = function() {
        return this.each(function() {
            function b() {
                ...
                a(window).off("scroll.materialbox"),
                a(document).off("keyup.materialbox"),
                a(window).off("resize.materialbox"),
            ...
            if (!a(this).hasClass("initialized")) {
                ...
                var c, d, e = !1, f = !0, g = 200, h = a(this), i = a("<div></div>").addClass("material-placeholder"), j = h.attr("style");
                h.wrap(i),
                h.on("click", function() {
                    ...
                    for (; null !== d && !a(d).is(document); ) {
                        var m = a(d);
                        "visible" !== m.css("overflow") && (m.css("overflow", "visible"),
                        c = void 0 === c ? m : c.add(m)),
                        d = d.parentNode
                    }
                    h.css({
                        position: "absolute",
...
function(a) {
    var b = {
        init: function(b) {
            ...
            return this.each(function(c) {
                var e, f, g, h, i, j = d + c, k = a(this), l = a(window).width(), m = k.find("li.tab a"), n = k.width(), o = a(), p = Math.max(n, k[0].scrollWidth) / m.length, q = prev_index = 0, r = !1, s = function(a) {
                ...
                f.addClass("active")),
                k.find(".indicator").length || k.append('<li class="indicator"></li>'),
                h = k.find(".indicator"),
                k.append(h),
                ...
                k.off("click.tabs").on("click.tabs", "a", function(c) {
                    ...
                    if (!a(this).attr("target")) {
                        ...
                        q = m.index(a(this)),
                        q < 0 && (q = 0),
                        b.swipeable ? o.length && o.carousel("set", q, function() {
                            "function" == typeof b.onShow && b.onShow.call(k[0], f)
                        }) : (void 0 !== f && (f.show(),
                        f.addClass("active"),
    ...
    a.fn.tooltip = function(c) {
        ...
        this.each(function() {
            var d = Materialize.guid()
              , e = a(this);
            e.attr("data-tooltip-id") && a("#" + e.attr("data-tooltip-id")).remove(),
            e.attr("data-tooltip-id", d);
            var f, g, h, i, j, k, l = function() {
                f = e.attr("data-html") ? "true" === e.attr("data-html") : c.html,
                g = e.attr("data-delay"),
                g = void 0 === g || "" === g ? c.delay : g,
                h = e.attr("data-position"),
                h = void 0 === h || "" === h ? c.position : h,
                i = e.attr("data-tooltip"),
                i = void 0 === i || "" === i ? c.tooltip : i
            };
            l();
            j = function() {
                var b = a('<div class="material-tooltip"></div>');
                return i = f ? a("<span></span>").html(i) : a("<span></span>").text(i),
                b.append(i).appendTo(a("body")).attr("id", d),
                k = a('<div class="backdrop"></div>'),
                k.appendTo(b),
                b
            }(),
            ...
            e.on({
                "mouseenter.tooltip": function(a) {
                    var c = function() {
                        ...
                        var a, c, d, f = e.outerWidth(), g = e.outerHeight(), i = j.outerHeight(), m = j.outerWidth(), o = "0px", p = "0px", q = k[0].offsetWidth, r = k[0].offsetHeight, s = 8, t = 8, u = 0;
                        "top" === h ? (a = e.offset().top - i - 5,
                        c = e.offset().left + f / 2 - m / 2,
                        d = b(c, a, m, i),
                        o = "-10px",
                        k.css({
                            bottom: 0,
                        ...
                        k.css({
                            ...
                            marginTop: i / 2,
                            marginLeft: m
                        })) : "right" === h ? (a = e.offset().top + g / 2 - i / 2,
                        c = e.offset().left + f + 5,
                        d = b(c, a, m, i),
                        p = "+10px",
                        k.css({
                            ...
                            marginTop: i / 2,
                            marginLeft: "0px"
                        })) : (a = e.offset().top + e.outerHeight() + 5,
                        c = e.offset().left + f / 2 - m / 2,
                        d = b(c, a, m, i),
                        o = "+10px",
                        k.css({
                        ...
                        s = Math.SQRT2 * m / parseInt(q),
                        t = Math.SQRT2 * i / parseInt(r),
                        u = Math.max(s, t),
                        j.velocity({
                            translateY: o,
                            translateX: p
...
Materialize.toast = function(a, b, c, d) {
    ...
    null != h && (g = setInterval(function() {
        null === f.parentNode && window.clearInterval(g),
        f.classList.contains("panning") || (h -= 20),
        h <= 0 && (Vel(f, {
            opacity: 0,
            marginTop: "-40px"
        }, {
            ...
            a(this).each(function() {
                ...
                f.hammer({
                    ...
                    if ("touch" == c.gesture.pointerType) {
                        ...
                        if (h.css("overflow", "hidden"),
                        h.width(k),
                        0 === j.length && (j = a('<div id="sidenav-overlay"></div>'),
                        ...
                        "left" === b.edge)
                            ...
                            l < 0 && (l = 0),
                            e.css("transform", "translateX(" + l + "px)")
                        }
                        var m;
                        "left" === b.edge ? (m = d / b.menuWidth,
                        j.velocity({
                            opacity: m
                        }, {
                            duration: 10,
                            queue: !1,
                            easing: "easeOutQuad"
                        })) : (m = Math.abs((d - window.innerWidth) / b.menuWidth),
                        j.velocity({
                            opacity: m
                        }, {
                            duration: 10,
...
function(a) {
    ...
    a.scrollSpy = function(b, d) {
        ...
        b.on("scrollSpy:enter", function() {
            ...
            var b = a(this);
            i[0] ? (a(d.getActiveElement(i[0].attr("id"))).removeClass(d.activeClass),
            b.data("scrollSpy:id") < i[0].data("scrollSpy:id") ? i.unshift(a(this)) : i.push(a(this))) : i.push(a(this)),
            a(d.getActiveElement(i[0].attr("id"))).addClass(d.activeClass)
        }),
...
function(a) {
    a(document).ready(function() {
        function b(b) {
            ...
            f && d.css("line-height", f),
            b.data("original-height") || b.data("original-height", b.height()),
            ...
            b.data("original-height") <= d.height() ? b.css("height", d.height()) : b.val().length < b.data("previous-length") && b.css("height", b.data("original-height")),
        ...
        a(document).on("blur", c, function() {
            var b = a(this)
              , c = ".prefix";
            0 === b.val().length && !0 !== b[0].validity.badInput && void 0 === b.attr("placeholder") && (c += ", label"),
        ...
        a(document).on("input mousemove touchmove", ".range-field", function(b) {
            ...
            if (f) {
                c.hasClass("active") || g(c);
                var i = h(d);
                c.addClass("active").css("left", i),
                c.find(".value").html(c.siblings(e).val())
            }
        }),
            ...
            this.each(function() {
                ...
                if (!a.isEmptyObject(e)) {
                    ...
                    d.off("keydown.autocomplete").on("keydown.autocomplete", function(a) {
                        ...
                        if (13 === c && g >= 0)
                            return b = j.children("li").eq(g),
                            void (b.length && (b.trigger("mousedown.autocomplete"),
                            a.preventDefault()));
                        38 !== c && 40 !== c || (a.preventDefault(),
                        38 === c && g > 0 && g--,
                        40 === c && g < d - 1 && g++,
                        e.removeClass("active"),
                ...
                var r = function(b, c, d) {
                  ...
                  , t = function(b) {
                    ...
                    if (13 != b.which || i.is(":visible")) {
                        ...
                        38 == b.which && (g = i.find("li.selected").prev("li:not(.disabled)")[0]) && r(i, g),
                        setTimeout(function() {
                            s = []
                        }, 1e3)
                    }
        ...
        init: function(b) {
            ...
            this.each(function() {
                ...
                function d(a) {
                    ...
                    (k = i.find(".active").index()) != a && (e = j.eq(k),
    ...
    a(document).ready(function() {
        a(document).on("click.card", ".card", function(b) {
            if (a(this).find("> .card-reveal").length) {
                ...
                void 0 === c.data("initialOverflow") && c.data("initialOverflow", void 0 === c.css("overflow") ? "" : c.css("overflow")),
                a(b.target).is(a(".card-reveal .card-title")) || a(b.target).is(a(".card-reveal .card-title i")) ? a(this).find(".card-reveal").velocity({
                    translateY: 0
                }, {
                    duration: 225,
                    queue: !1,
                ...
                }) : (a(b.target).is(a(".card .activator")) || a(b.target).is(a(".card .activator i"))) && (c.css("overflow", "hidden"),
    ...
    a.fn.material_chip = function(c) {
        ...
        this.handleEvents = function() {
            ...
            d.$document.off("focusout.chips", b.CHIPS + " " + b.INPUT).on("focusout.chips", b.CHIPS + " " + b.INPUT, function(c) {
                var d = a(c.target).closest(b.CHIPS);
                d.removeClass("focus"),
                void 0 !== d.data("chips") && d.data("chips").length || d.siblings("label").removeClass("active"),
        ...
        this.chips = function(b, c) {
            ...
            void 0 !== b.data("chips") && b.data("chips").length && f.addClass("active"));
            var g = a("#" + c);
        ...
        this.renderChip = function(b) {
            if (b.tag) {
                ...
                return c.text(b.tag),
                b.image && c.prepend(a("<img />").attr("src", b.image)),
    ...
    var b = function(b) {
      ...
      , e = function(a) {
        if ("true" === a.attr("data-open")) {
            var b, c, d = window.innerWidth, e = window.innerHeight, f = a.attr("data-origin-width"), g = a.attr("data-origin-bottom"), h = a.attr("data-origin-left"), i = a.find("> .btn-floating").first(), j = a.find("> ul").first(), k = a.find(".fab-backdrop"), l = i.css("background-color");
            b = h - d / 2 + f / 2,
            c = e - g,
            d / k.width(),
    ...
    function b(f, g, i, l) {
        ...
        function q(a) {
            ...
            if (27 == b)
                return y.close(),
                !1;
            (32 == b || c || !t.open && y.component.key[b]) && (a.preventDefault(),
            a.stopPropagation(),
...
function(a) {
    ...
    c.prototype.create = function(a, c, e) {
        ...
        c == -1 / 0 || c == 1 / 0 ? f = c : b.isPlainObject(c) && d.isInteger(c.pick) ? c = c.obj : b.isArray(c) ? (c = new Date(c[0],c[1],c[2]),
    ...
    c.prototype.deactivate = function(a, c) {
        ...
        return "flip" == c ? e.flipEnable() : !1 === c ? (e.flipEnable(1),
        f = []) : !0 === c ? (e.flipEnable(-1),
        f = []) : c.map(function(a) {
    ...
    c.prototype.activate = function(a, c) {
        var e = this
          , f = e.item.disable
          , g = f.length;
        return "flip" == c ? e.flipEnable() : !0 === c ? (e.flipEnable(1),
        f = []) : !1 === c ? (e.flipEnable(-1),
        f = []) : c.map(function(a) {
            var c, h, i, j;
            for (i = 0; i < g; i += 1) {
                if (h = f[i],
                ...
                if (e.isDateOverlap(h, a)) {
                    ...
                    c = a) : b.isArray(a) ? (c = a,
                    c[3] || c.push("inverted")) : d.isDate(a) && (c = [a.getFullYear(), a.getMonth(), a.getDate(), "inverted"]);
                    break
                }
            }
            if (c)
    ...
    c.prototype.nodes = function(a) {
        var b = this
          ...
          , m = function(a, b) {
            ...
            b.push(b.shift())),
            d.node("thead", d.node("tr", d.group({
                min: 0,
                max: 6,
                i: 1,
                node: "th",
          ...
          , o = function(e) {
            ...
            return "short_months" == e && (f = c.monthsShort),
            c.selectMonths && void 0 == e ? d.node("select", d.group({
                min: 0,
                max: 11,
                i: 1,
                node: "option",
        ...
        createWeekdayLabel = function() {
            var a;
            return a = null != g ? g.day : f.day,
            c.weekdaysShort[a]
        }
        ,
        d.node("div", d.node("div", p("raw"), c.klass.year_display) + d.node("span", createWeekdayLabel() + ", ", "picker__weekday-display") + d.node("span", o("short_months") + " ", c.klass.month_display) + d.node("span", createDayLabel(), c.klass.day_display), c.klass.date_display) + d.node("div", d.node("div", d.node("div", (c.selectYears,
                ...
                return [d.group({
                    ...
                    item: function(a) {
                        ...
                        return [d.node("div", a.date, function(b) {
                            return b.push(i.month == a.month ? c.klass.infocus : c.klass.outfocus),
...
function() {
    ...
    function d(d, g) {
        function i(a, b) {
            ...
            if (!b || !(k < s - u || k > s + u)) {
                ...
                h.off(o).on(o, function(a) {
                    ...
                    (b || m) && d === i && k === j && D.setHand(d, k),
                    "hours" === D.currentView ? D.toggleView("minutes", w / 2) : g.autoclose && (D.minutesView.addClass("clockpicker-dial-out"),
                    setTimeout(function() {
                        D.done()
                    }, w / 2)),
                    l.prepend(K),
        ...
        this.spanAmPm = k.find(".clockpicker-span-am-pm"),
        this.footer = k.find(".picker__footer"),
        this.amOrPm = "PM",
        g.twelvehour && (g.ampmclickable ? (this.spanAmPm.empty(),
        f('<div id="click-am">AM</div>').on("click", function() {
            D.spanAmPm.children("#click-am").addClass("text-primary"),
            D.spanAmPm.children("#click-pm").removeClass("text-primary"),
            D.amOrPm = "AM"
        }).appendTo(this.spanAmPm),
        f('<div id="click-pm">PM</div>').on("click", function() {
        ...
        f('<div id="click-am">AM</div>').appendTo(this.spanAmPm),
        f('<div id="click-pm">PM</div>').appendTo(this.spanAmPm))),
        f('<button type="button" class="btn-flat picker__clear" tabindex="' + (g.twelvehour ? "3" : "1") + '">' + g.cleartext + "</button>").click(f.proxy(this.clear, this)).appendTo(this.footer),
        f('<button type="button" class="btn-flat picker__close" tabindex="' + (g.twelvehour ? "3" : "1") + '">' + g.canceltext + "</button>").click(f.proxy(this.hide, this)).appendTo(this.footer),
        f('<button type="button" class="btn-flat picker__close" tabindex="' + (g.twelvehour ? "3" : "1") + '">' + g.donetext + "</button>").click(f.proxy(this.done, this)).appendTo(this.footer),
        this.spanHours.click(f.proxy(this.toggleView, this, "hours")),
        this.spanMinutes.click(f.proxy(this.toggleView, this, "minutes")),
        B.on("focus.clockpicker click.clockpicker", f.proxy(this.show, this));
        ...
        j) {
            ...
            O.setAttribute("y1", 0);
            var P = a("circle");
            P.setAttribute("class", "clockpicker-canvas-bg"),
            P.setAttribute("r", u),
            M.appendChild(O),
            M.appendChild(P),
            M.appendChild(N),
    ...
    var f = window.jQuery
      ...
      , j = "SVGAngle"in window && function() {
        ...
        a = (b.firstChild && b.firstChild.namespaceURI) == i,
        b.innerHTML = "",
        a
    }()
      , k = function() {
    ...
    d.prototype.show = function(a) {
        if (!this.isShown) {
            ...
            f(document.body).css("overflow", "hidden");
            var d = ((this.input.prop("value") || this.options.default || "") + "").split(":");
            if (this.options.twelvehour && void 0 !== d[1] && (d[1].indexOf("AM") > 0 ? this.amOrPm = "AM" : this.amOrPm = "PM",
            d[1] = d[1].replace("AM", "").replace("PM", "")),
            "now" === d[0]) {
            ...
            this.locate(),
            this.isShown = !0,
            h.on("click.clockpicker." + this.id + " focusin.clockpicker." + this.id, function(a) {
                var b = f(a.target);
    ...
    d.prototype.hide = function() {
        ...
        this.isShown = !1,
        f(":input").each(function(a) {
            f(this).attr("tabindex", a + 1)
        }),
        h.off("click.clockpicker." + this.id + " focusin.clockpicker." + this.id),
        h.off("keyup.clockpicker." + this.id),
        this.popover.hide(),
    ...
    d.prototype.toggleView = function(a, b) {
        var c = !1;
        "minutes" === a && "visible" === f(this.hoursView).css("visibility") && (e(this.options.beforeHourSelect),
        c = !0);
        var d = "hours" === a
        ...
        g.css("visibility", "visible").removeClass("clockpicker-dial-out"),
        this.resetClock(b),
    ...
    d.prototype.resetClock = function(a) {
        var b = this.currentView
          ...
          , i = -Math.cos(f) * g
          , k = this;
        j && a ? (k.canvas.addClass("clockpicker-canvas-out"),
        setTimeout(function() {
            k.canvas.removeClass("clockpicker-canvas-out"),
            k.setHand(h, i)
        }, a)) : this.setHand(h, i)
    }
    ,
    d.prototype.setHand = function(a, c, d, e) {
        var g, h = Math.atan2(a, -c), i = "hours" === this.currentView, k = Math.PI / (i || d ? 6 : 30), l = Math.sqrt(a * a + c * c), m = this.options, n = i && l < (s + t) / 2, o = n ? t : s;
        if (m.twelvehour && (o = s),
        h < 0 && (h = 2 * Math.PI + h),
        g = Math.round(h / k),
        h = g * k,
        m.twelvehour ? i ? 0 === g && (g = 12) : (d && (g *= 5),
        60 === g && (g = 0)) : i ? (12 === g && (g = 0),
        g = n ? 0 === g ? 12 : g : 0 === g ? 0 : g + 12) : (d && (g *= 5),
        60 === g && (g = 0)),
        this[this.currentView] !== g && p && this.options.vibrate && (this.vibrateTimer || (navigator[p](10),
        this.vibrateTimer = setTimeout(f.proxy(function() {
            this.vibrateTimer = null
        }, this), 100))),
        this[this.currentView] = g,
        i ? this.spanHours.html(g) : this.spanMinutes.html(b(g)),
        !j)
        ...
        var q = Math.sin(h) * (o - u)
          ...
          , v = Math.sin(h) * o
          , w = -Math.cos(h) * o;
        this.hand.setAttribute("x2", q),
        this.hand.setAttribute("y2", r),
        this.bg.setAttribute("cx", v),
        this.bg.setAttribute("cy", w)
    }
    ,
    d.prototype.done = function() {
        e(this.options.beforeDone),
        this.hide(),
    ...
    d.prototype.clear = function() {
        ...
        "" !== a && (this.input.triggerHandler("change"),
        this.isInput || this.element.trigger("change")),
        this.options.autoclose && this.input.trigger("blur")
    }
    ,
    d.prototype.remove = function() {
        ...
        this.isAppended && (g.off("resize.clockpicker" + this.id),
        this.popover.remove())
    }
    ,
...
function(a) {
    ...
    a.fn.characterCounter = function() {
        return this.each(function() {
            var e = a(this);
            e.parent().find('span[class="character-counter"]').length || void 0 !== e.attr("data-length") && (e.on("input", b),
            e.on("focus", b),
            e.on("blur", d),
            c(e))
        })
        ...
        init: function(b) {
            ...
            return this.each(function(c) {
                ...
                function h(c) {
                    ...
                    if (s = "number" == typeof c ? c : s,
                    t = Math.floor((s + v / 2) / v),
                    f = s - t * v,
                    h = f < 0 ? 1 : -1,
                    i = -h * f * 2 / v,
                    e = w >> 1,
                    b.fullWidth ? k = "translateX(0)" : (k = "translateX(" + (O[0].clientWidth - q) / 2 + "px) ",
                    k += "translateY(" + (O[0].clientHeight - r) / 2 + "px)"),
                    P) {
                        var m = t % w
                          , n = L.find(".indicator-item.active");
                        n.index() !== m && (n.removeClass("active"),
                        L.find(".indicator-item").eq(m).addClass("active"))
                    }
                    for ((!b.noWrap || t >= 0 && t < w) && (j = p[g(t)],
                    a(j).hasClass("active") || (O.find(".carousel-item").removeClass("active"),
                    a(j).addClass("active")),
                    j.style[E] = k + " translateX(" + -f / 2 + "px) translateX(" + h * b.shift * i * d + "px) translateZ(" + b.dist * i + "px)",
                    j.style.zIndex = 0,
                    ...
                    d = 1; d <= e; ++d)
                        ...
                        tweenedOpacity = d === e && f < 0 ? 1 - i : 1) : (zTranslation = b.dist * (2 * d + i * h),
                        tweenedOpacity = 1 - .2 * (2 * d + i * h)),
                        (!b.noWrap || t + d < w) && (j = p[g(t + d)],
                        j.style[E] = k + " translateX(" + (b.shift + (v * d - f) / 2) + "px) translateZ(" + zTranslation + "px)",
                        j.style.zIndex = -d,
                        j.style.opacity = tweenedOpacity,
                        j.style.display = "block"),
                        b.fullWidth ? (zTranslation = b.dist,
                        tweenedOpacity = d === e && f > 0 ? 1 - i : 1) : (zTranslation = b.dist * (2 * d - i * h),
                        tweenedOpacity = 1 - .2 * (2 * d - i * h)),
                        (!b.noWrap || t - d >= 0) && (j = p[g(t - d)],
                        j.style[E] = k + " translateX(" + (-b.shift + (-v * d - f) / 2) + "px) translateZ(" + zTranslation + "px)",
                        j.style.zIndex = -d,
                        j.style.opacity = tweenedOpacity,
                        j.style.display = "block");
                    if ((!b.noWrap || t >= 0 && t < w) && (j = p[g(t)],
                    j.style[E] = k + " translateX(" + -f / 2 + "px) translateX(" + h * b.shift * i + "px) translateZ(" + b.dist * i + "px)",
                    j.style.zIndex = 0,
                    b.fullWidth ? tweenedOpacity = 1 : tweenedOpacity = 1 - .2 * i,
                    j.style.opacity = tweenedOpacity,
                    j.style.display = "block"),
                    l !== t && "function" == typeof b.onCycleTo) {
                        var o = O.find(".carousel-item").eq(g(t));
                        b.onCycleTo.call(this, o, I)
                    }
                    "function" == typeof N && (N.call(this, o, I),
                    N = null)
                }
                function i() {
                    var a, b, c, d;
                ...
                function j() {
                    var a, c;
                    A && (a = Date.now() - G,
                    c = A * Math.exp(-a / b.duration),
                    c > 2 || c < -2 ? (h(B - c),
                    requestAnimationFrame(j)) : h(B))
                }
                function k(c) {
                    if (I)
                        return c.preventDefault(),
                ...
                function l(a) {
                    var c = t % w - a;
                    b.noWrap || (c < 0 ? Math.abs(c + w) < Math.abs(c) && (c += w) : c > 0 && Math.abs(c - w) < c && (c -= w)),
                ...
                function o(a) {
                    if (u)
                        ...
                        B = s + A),
                        B = Math.round(B / v) * v,
                        b.noWrap && (B >= v * (w - 1) ? B = v * (w - 1) : B < 0 && (B = 0)),
                        A = B - s,
                        G = Date.now(),
                ...
                var p, q, r, s, t, u, v, w, x, z, A, B, C, D, E, F, G, H, I, J, K = d + c, L = a('<ul class="indicators"></ul>'), M = null, N = null, O = a(this), P = O.attr("data-indicators") || b.indicators;
                ...
                O.hasClass("initialized"))
                    return a(window).trigger("resize"),
                ...
                s = B = 0,
                p = [],
                q = O.find(".carousel-item").first().innerWidth(),
                r = O.find(".carousel-item").first().innerHeight(),
                v = 2 * q + b.padding,
                ...
                ["webkit", "Moz", "O", "ms"].every(function(a) {
                    var b = a + "Transform";
                    return void 0 === document.body.style[b] || (E = b,
                    !1)
                }),
                a(window).off("resize.carousel-" + K).on("resize.carousel-" + K, function() {
                    b.fullWidth ? (q = O.find(".carousel-item").first().innerWidth(),
                    r = O.find(".carousel-item").first().innerHeight(),
                    v = 2 * q + b.padding,
                    s = 2 * t * q,
                    B = s) : h()
                ...
                function() {
                    void 0 !== window.ontouchstart && (O[0].addEventListener("touchstart", m),
                    O[0].addEventListener("touchmove", n),
                    O[0].addEventListener("touchend", o)),
                    O[0].addEventListener("mousedown", m),
                    O[0].addEventListener("mousemove", n),
                    O[0].addEventListener("mouseup", o),
                    O[0].addEventListener("mouseleave", o),
                    O[0].addEventListener("click", k)
                }(),
                h(s),
                a(this).on("carouselNext", function(a, b, c) {
                    void 0 === b && (b = 1),
                    "function" == typeof c && (N = c),
                    B = v * Math.round(s / v) + v * b,
                    s !== B && (A = B - s,
                    G = Date.now(),
                    requestAnimationFrame(j))
                }),
